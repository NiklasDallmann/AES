...
//			this->_addRoundKey(round);
	...
	void generateT3()
	{
		...
		for (uint32_t a = 0; a <= 0xff; a++)
		{
			...
			ptr[2] = _galoisMultiply_2[_sBox_enc[a]];
			ptr[0] = _sBox_enc[a];
			ptr[1] = _sBox_enc[a];
			ptr[3] = _galoisMultiply_2[_sBox_enc[a]];
...
private:
	...
	static const uint32_t _t0_enc[];
	static const uint32_t _t1_enc[];
	static const uint32_t _t2_enc[];
	static const uint32_t _t3_enc[];
...
template <uint8_t keySize>
const uint32_t PrimitiveBlock<keySize>::_t0_enc[] = {
...
template <uint8_t keySize>
const uint32_t PrimitiveBlock<keySize>::_t1_enc[] = {
...
template <uint8_t keySize>
const uint32_t PrimitiveBlock<keySize>::_t2_enc[] = {
...
template <uint8_t keySize>
const uint32_t PrimitiveBlock<keySize>::_t3_enc[] = {
